// coda di dimensione dinamica, implementata come lista di Nodi generici
public class DynamicQueue<T> {
	...
	public boolean equals(DynamicQueue<T> y){
		DynamicQueue<T> tmpX = this;
		DynamicQueue<T> tmpY = y;
		if(tmpX == null && tmpY == null && y == null){
			return true;
		}else if((tmpX == null || tmpY == null) && y != null){
			return false;
		}else{
			return tmpX.dequeue() == tmpY.dequeue() && tmpX.equals(tmpY);
		}
	}
    ...
    // rimuovi e ritorna l'elemento generico in testa alla coda
    public T dequeue() {
